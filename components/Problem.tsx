        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <ul className="mt-6 space-y-3">
              {[
                t.problem.without.item1,
                t.problem.without.item2,
                t.problem.without.item3,
                t.problem.without.item4,
              ].map((item, i) => (
          ...
          <div className="rounded-2xl border-2 border-emerald-200 bg-emerald-50/30 p-8 shadow-sm">
            ...
            <ul className="mt-6 space-y-3">
              {[
                t.problem.with.item1,
                t.problem.with.item2,
                t.problem.with.item3,
                t.problem.with.item4,
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-3">
